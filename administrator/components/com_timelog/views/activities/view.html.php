...
class TimelogViewActivities extends HtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_TIMELOG_TITLE_ACTIVITIES'), 'clock');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_ADMINISTRATOR . '/components/com_timelog/views/activity';
		...
		if ($canDo->core_edit_state ?? $canDo->get('core.edit.state'))
		{
			...
			{
				ToolbarHelper::checkin('activities.checkin', 'JTOOLBAR_CHECKIN', true);
			}
		}
