...
class SlaFactory
{
	...
	public static function table($name)
	{
		...
		return Factory::getApplication()->bootComponent('com_sla')->getMVCFactory()->createTable($name, 'Administrator');
	}
	...
	public static function model($name, $config = array())
	{
		...
		// @TODO Add support for cache
		return Factory::getApplication()->bootComponent('com_sla')->getMVCFactory()->createModel($name, 'Administrator', $config);
	}
}
